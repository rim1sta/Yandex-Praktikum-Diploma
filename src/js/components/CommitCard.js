...
<p class="slider__commit"></p>
  ...
  create() {
    ...
    this.card.querySelector(
      ".slider__date"
    ).textContent = this.item.commit.committer.date;
    this.card.querySelector(
      ".slider__user-name"
    ).textContent = this.item.commit.author.name;
    this.card.querySelector(
      ".slider__user-mail"
    ).textContent = this.item.commit.committer.email;
    this.card.querySelector(
      ".slider__commit"
    ).textContent = this.item.commit.message;
